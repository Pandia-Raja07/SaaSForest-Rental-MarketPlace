<div>
    ...
    <div x-data="{
        ...
        setBook: false
    }" class="w-full container mx-auto px-1 py-10">
        <div class="flex justify-between items-center">
            <div>

                <svg width="102" height="32" class="text-red-800" style="display: block;fill :blue">
                    <path
            ...
            <div class="flex gap-x-10 justify-between items-center font-bold text-sm">
                <p>Airbnb Your Home</p>
                <div x-data="{ open: false }"
                    class="relative flex justify-center border border-black rounded-3xl w-28 h-14 gap-x-5 py-2">
                    <div class="flex items-center">
                        <svg @click="open = !open" xmlns="http://www.w3.org/2000/svg" class="w-7 h-7 cursor-pointer"
                    ...
                    <div x-show="open" @click.away="open = false"
                        class="absolute top-full mt-2 w-40 bg-white border border-gray-300 rounded-lg shadow-lg text-sm">
                        <a href="#" class="block px-4 py-2 text-gray-800 hover:bg-gray-200">Sign Up</a>
                        <a href="#" class="block px-4 py-2 text-gray-800 hover:bg-gray-200">Login</a>
                        <div class ="border border-b  black">
                            <a href="#" class="block px-4 py-2 text-gray-800 hover:bg-gray-200">Airbnb Your
                                Home</a>
                            <a href="#" class="block px-4 py-2 text-gray-800 hover:bg-gray-200">Help Center</a>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="container mx-auto px-5 py-4 flex justify-center">
            ...
            <div x-show="currentTab === 'stays'"
                ...
                <div x-data="{ showDropdown: false }" class="relative">
                    <div
                        ...
                        <div x-show="showDropdown" @click.outside="showDropdown = false" x-transition
                            class="absolute mt-2 w-[400px] bg-white border border-gray-300  shadow-lg p-6  rounded-3xl">
                ...
                <div class="relative"
                    class="w-36 check-in px-10 py-3 cursor-pointer transition duration-250 ease-in-out hover:bg-gray-100 rounded-full">

                    <div @click="setBook = !setBook" class="mb-1 ml-5">Check in</div>
                    <input type="text" placeholder="Add dates" class="w-full bg-transparent ml-5 ">
                    ...
                    <div class="flex flex-col items-center justify-center">
                        <div class=" p-2 px-5 ">
                            <div class="flex justify-center items-center gap-x-10">
                                <div>
                                    <p :class="{ 'text-blue-700': currentTab === 'fromDate' }"
                                ...
                                <div>
                                    <p :class="{ 'text-blue-700': currentTab === 'flexibleTime' }"
                                        @click="currentTab = 'flexibleTime'; fromDate = false;"
